...
function SelectAMA() {
  ...
  const getActiveButton = () => {
    if (path === "/admin") return "history";
    if (path === "/select") return "select";
    return null;
  };
      ...
      <div className="admin_page">
        ...
        <div className="toggle">
          <Link className="toggle_link" to="/admin">
            <button className={`hist_btn ${activeButton === 'history' ? 'active' : ''}`}>History</button>
          </Link>
          <Link className="toggle_link" to="/select">
            <button className={`select_btn ${activeButton === 'select' ? 'active' : ''}`}>Select</button>
          </Link>
        </div>
